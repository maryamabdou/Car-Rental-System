...
if (isset($_POST['Display2'])) {
    ...
    $sql = "SELECT plate_id, model, `year`, car_status, office_loc FROM car 
    NATURAL JOIN reserve
    WHERE plate_id = '$car' and (start_date BETWEEN '$start2' and '$end2' OR end_date BETWEEN '$start2' and '$end2')";
